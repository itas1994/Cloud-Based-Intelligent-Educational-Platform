...
<html>
  <head>
	...
	<link rel="stylesheet" type="text/css" href="css/group/groupcount.css">
  ...
  <body>
    ...
    <div id="panel_title">
    	<label id="fenzu">★请输入分组数量</label>
    </div>
  	<div id="resultpanel">
  		<div id="resultcontent">
  			<form id="form1" action="GroupAction!execute.action" method="post">
  				<label id="notice">分组数量:</label>
    			<input id="num" name="num" type="text" />
    			<input id="submit" name="submit" class="btn" type="submit" value="提交" />
  			</form>
  		</div>
  	</div>
  </body>
